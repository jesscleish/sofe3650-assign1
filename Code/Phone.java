...
public class Phone implements Product {
    ...
    public Phone(){
        ...
        phoneIndex = pricesArray.indexOf("PHONE");
        productName = pricesArray.get(phoneIndex);

        phoneIndex++;
        // Assign price to object based on price array location, parsing from string to double to preserve formatting
        price = Double.parseDouble(pricesArray.get(phoneIndex));
    }
  
    
    public double getPrice(){ // gets the price of the phone
        return this.price;
    }
